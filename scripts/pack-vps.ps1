...
# En el VPS usa localhost para RCON.

LIVEKIT_URL=
LIVEKIT_API_KEY=
LIVEKIT_API_SECRET=
LIVEKIT_ROOM=islaprime

ISLE_RCON_HOST=127.0.0.1
ISLE_RCON_PORT=8888
ISLE_RCON_PASSWORD=
...
echo.
echo  Isla Prime — web
echo  Abre http://TU-IP-VPS:3000
echo  Cierra esta ventana para detener la web.
echo.

if not exist ".env.local" (
  echo [!] Falta .env.local
  echo     Copia .env.example a .env.local y pon la password RCON.
  echo.
  pause
  exit /b 1
)
